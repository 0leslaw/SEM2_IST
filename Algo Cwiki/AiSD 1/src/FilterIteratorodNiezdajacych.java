...
public class FilterIteratorodNiezdajacych implements Iterator<Student> {
    private Iterator<Student> iterator_wewnetrzny;
    private Predicate<Student> predykat = (e) -> e.getOcena()<3;
    private Student tymczasowa_zwrocona_wartosc;
    private boolean hasNext_mojego_iteratora = true;

    public FilterIteratorodNiezdajacych(Iterator<Student> iterator_wewnetrzny) {
        super();
